...
static constexpr uint16_t CHART_POINTS = 240;
static constexpr int32_t CHART_MAX_KBPS = 12288;
static constexpr uint32_t STATS_REFRESH_MS = 500;
static constexpr uint32_t STATS_HTTP_TIMEOUT_MS = 2000;
...
static constexpr bool USE_GATEWAY_FOR_STATS = true;
